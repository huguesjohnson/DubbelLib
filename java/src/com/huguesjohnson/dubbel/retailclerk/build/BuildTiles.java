...
public class BuildTiles extends BaseBuilder{
	...
	public static HashMap<String,Tileset> build(String basePath,TilesetParameters tiles,HashMap<String,PaletteMap> paletteMap) throws Exception{
		...
		try{
			...
			String tileIncludeFilePath=PathResolver.getAbsolutePath(basePath,tiles.tileIncludeFilePath);
			...
			tileIncludeWriter.write(newLine);
			String patternIncludeFilePath=PathResolver.getAbsolutePath(basePath,tiles.patternIncludeFilePath);
			...
			for(Tileset entry:tiles.tilesets){
				...
				String tileOutputPath=PathResolver.getAbsolutePath(basePath,entry.destinationFilePath);
				...
				String sourceFilePath=PathResolver.getAbsolutePath(basePath,entry.sourceFilePath);
