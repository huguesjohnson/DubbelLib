	...
	public static HashMap<String,PaletteMap> build(String basePath,PaletteParameters parameters) throws Exception{
		...
		try{
			...
			for(PaletteMap entry:paletteMap){
				sourceFilePath=PathResolver.getAbsolutePath(basePath,entry.sourceFilePath);
				outputFilePath=PathResolver.getAbsolutePath(basePath,entry.destinationFilePath);
