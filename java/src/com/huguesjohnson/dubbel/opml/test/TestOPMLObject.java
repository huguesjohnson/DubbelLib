...
class TestOPMLObject{
	private final static String originalOPML="<?xml version=\"1.0\" encoding=\"UTF-8\"?>\n" + 
			"<opml version=\"2.0\">\n" + 
			"<head>\n" + 
	...
	@Test
	void testSortOutlines(){
		//this also inadvertently tests OPMLParser and I'm aware it's not a great idea to combine these things
		try{
			InputStream in=new ByteArrayInputStream(originalOPML.getBytes(StandardCharsets.UTF_8));
			OPMLObject testOpml=OPMLParser.parse(in);
			testOpml.sortOutlines();
			assertEquals(testOpml.getVersion(),"2.0");
			assertEquals(testOpml.getHead().getTitle(),"Example subscriptions in feedly");
			assertEquals(testOpml.getBody().get(2).getText(),"Video Game Music");
			assertEquals(testOpml.getBody().get(2).getTitle(),"Video Game Music");
			assertEquals(testOpml.getBody().get(2).getChildren().get(0).getTitle(),"10 Latest OverClocked ReMixes");
			assertEquals(testOpml.getBody().get(2).getChildren().get(0).getText(),"10 Latest OverClocked ReMixes");
			assertEquals(testOpml.getBody().get(2).getChildren().get(0).getType(),"rss");
			assertEquals(testOpml.getBody().get(2).getChildren().get(0).getXmlUrl(),"http://ocremix.org/feeds/ten20/");
			assertEquals(testOpml.getBody().get(2).getChildren().get(0).getHtmlUrl(),"https://ocremix.org");
			assertEquals(testOpml.getBody().get(2).getChildren().get(1).getTitle(),"Nerd Noise Radio");
			assertEquals(testOpml.getBody().get(2).getChildren().get(1).getText(),"Nerd Noise Radio");
			assertEquals(testOpml.getBody().get(2).getChildren().get(1).getType(),"rss");
			assertEquals(testOpml.getBody().get(2).getChildren().get(1).getXmlUrl(),"https://feed.podbean.com/nerdnoiseradio/feed.xml");
			assertEquals(testOpml.getBody().get(2).getChildren().get(1).getHtmlUrl(),"https://nerdnoiseradio.podbean.com");
			assertEquals(testOpml.getBody().get(1).getText(),"Retro Technology");
			assertEquals(testOpml.getBody().get(1).getTitle(),"Retro Technology");
			assertEquals(testOpml.getBody().get(1).getChildren().get(1).getTitle(),"The Old New Thing");
			assertEquals(testOpml.getBody().get(1).getChildren().get(1).getText(),"The Old New Thing");
			assertEquals(testOpml.getBody().get(1).getChildren().get(1).getType(),"rss");
			assertEquals(testOpml.getBody().get(1).getChildren().get(1).getXmlUrl(),"http://blogs.msdn.com/b/oldnewthing/rss.aspx");
			assertEquals(testOpml.getBody().get(1).getChildren().get(1).getHtmlUrl(),"https://devblogs.microsoft.com/oldnewthing");
			assertEquals(testOpml.getBody().get(1).getChildren().get(0).getTitle(),"Atari Projects");
			assertEquals(testOpml.getBody().get(1).getChildren().get(0).getText(),"Atari Projects");
			assertEquals(testOpml.getBody().get(1).getChildren().get(0).getType(),"rss");
			assertEquals(testOpml.getBody().get(1).getChildren().get(0).getXmlUrl(),"http://atariprojects.org/feed/");
			assertEquals(testOpml.getBody().get(1).getChildren().get(0).getHtmlUrl(),"https://atariprojects.org");
			assertEquals(testOpml.getBody().get(0).getText(),"Retro Gaming");
			assertEquals(testOpml.getBody().get(0).getTitle(),"Retro Gaming");
			assertEquals(testOpml.getBody().get(0).getChildren().get(1).getTitle(),"Nerdly Pleasures");
			assertEquals(testOpml.getBody().get(0).getChildren().get(1).getText(),"Nerdly Pleasures");
			assertEquals(testOpml.getBody().get(0).getChildren().get(1).getType(),"rss");
			assertEquals(testOpml.getBody().get(0).getChildren().get(1).getXmlUrl(),"http://feeds.feedburner.com/NerdlyPleasures");
			assertEquals(testOpml.getBody().get(0).getChildren().get(1).getHtmlUrl(),"http://nerdlypleasures.blogspot.com/");
			assertEquals(testOpml.getBody().get(0).getChildren().get(2).getTitle(),"Nicole Express");
			assertEquals(testOpml.getBody().get(0).getChildren().get(2).getText(),"Nicole Express");
			assertEquals(testOpml.getBody().get(0).getChildren().get(2).getType(),"rss");
			assertEquals(testOpml.getBody().get(0).getChildren().get(2).getXmlUrl(),"https://nicole.express/feed.xml");
			assertEquals(testOpml.getBody().get(0).getChildren().get(2).getHtmlUrl(),"https://nicole.express/");
			assertEquals(testOpml.getBody().get(0).getChildren().get(0).getTitle(),"Midwest Gaming Classic");
			assertEquals(testOpml.getBody().get(0).getChildren().get(0).getText(),"Midwest Gaming Classic");
			assertEquals(testOpml.getBody().get(0).getChildren().get(0).getType(),"rss");
			assertEquals(testOpml.getBody().get(0).getChildren().get(0).getXmlUrl(),"http://www.midwestgamingclassic.com/feed/");
			assertEquals(testOpml.getBody().get(0).getChildren().get(0).getHtmlUrl(),"https://www.midwestgamingclassic.com");
